...
class WP_Admin_Bar_Effect {
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		wp_register_script( 'wabe-script', plugins_url( 'admin/js/jquery.wabe.min.js', __FILE__ ), array( 'jquery', 'hoverIntent' ), $this->wabe_version );
		...
		wp_register_style( 'wabe-style', plugins_url( 'admin/css/wabe.min.css', __FILE__ ), false, $this->wabe_version );
